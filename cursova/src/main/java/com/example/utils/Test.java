...
public class Test {
    public static void run(long seed, int retestNumb) {
        ...
        final Function<Integer, List<Double>> listGenerator = (size) -> {
            return genDoubleList(size, 1_000_000, seed);
        };
        ...
        threcholdScenario.outputResults();
        ///////////////////////////////////////////////////////
        ...
        sublistParamScenario.outputResults();

        // var mainScenario = TestScenario.makeScenario(
        //     listGenerator, Comparator.naturalOrder(), retestNumb
        // )
        //     .addLengthParams(200_000, 20_000_000, 0, 10)
        //     .addThreadNumbParams(2, 8, 0, 2)
        //     .addSublistParamParams(1092, 1092, 1, 1);

        // mainScenario.start();
        // mainScenario.outputResults();
    }

    private static List<Double> genDoubleList(int size, int bound, long seed) {
