...
import com.example.task2.StripeForkAlgorithm;
import com.example.utils.Matrix;

public class StripeForkAlgorithmTest 
{
    @Test
    public void testBasicMultiplication() {
        ...
        Matrix result = StripeForkAlgorithm.multiply(a, b, 2);
    ...
    public void testSingleThreadMultiplication() {
        ...
        Matrix expected = Matrix.multiply(a, b);
        Matrix result = StripeForkAlgorithm.multiply(a, b, 1);
    ...
    public void testMultipleThreadsMultiplication() {
        ...
        Matrix expected = Matrix.multiply(a, b);
        Matrix result = StripeForkAlgorithm.multiply(a, b, 4);
    ...
    public void testLargeMatrixWithExcessThreads() {
        ...
        Matrix expected = Matrix.multiply(a, b);
        Matrix result = StripeForkAlgorithm.multiply(a, b, 10);
